...
function addon:NormalizeSettingTypes(settings)
    ...
    normalize_bool(settings, "show_charge_cooldown", true)
    normalize_bool(settings, "show_loc_cooldown", true)
    normalize_bool(settings, "show_attack_flash", true)
    normalize_bool(settings, "show_proc_glow", true)
    normalize_bool(settings, "show_equipped_border", true)
    normalize_bool(settings, "show_pet_autocast", true)
