...
function addon:CreateMouseControls()
    ...
    local function OnMaximizeMouse()
        ...
        MouseControls.Slider = CreateFrame("Slider", "KUI_Slider2", MouseControls, "OptionsSliderTemplate")
        MouseControls.Slider:SetMinMaxValues(0.5, 1)
        ...
        _G[MouseControls.Slider:GetName().."High"]:SetText("1")
        ...
        MouseControls.EditBox:SetText(Mouseholder:GetScale())
